...
const OtherPageHeroShort = ({ image, name }: any) => {
  return (
    <div className="w-full aspect-[1920/490] min-h-[300px] flex flex-col items-center overflow-hidden relative">
      ...
      />
      <h1 className="text-center lg:text-6xl text-4xl 2xl:text-7xl text-white font-frinkRio font-bold left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] absolute z-20">
        {name}
      </h1>
    </div>
  );
