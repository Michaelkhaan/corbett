const TariffPrice=()=>{
    return (
        <div className="w-full bg-yellow-400 md:py-0 py-5 lg:px-0 px-4 flex justify-center items-center">
        <div className="lg:w-2/3 2xl:w-1/2 w-11/12 lg:flex-row flex-col flex justify-between items-start py-14 px-4">
          <div className="lg:w-1/3 w-full flex justify-start items-start">
            <p className="text-black text-lg font-GothamBook font-semibold ">Tariff Prices</p>
          </div>
