const TariffPrice=()=>{
    return (
        <div className="w-full bg-yellow-400 sm:h-[300px] h-auto md:py-0 py-5 lg:px-0 px-4 flex justify-center items-center">
        <div className="lg:w-[65%] w-full lg:flex-row flex-col flex justify-between items-start">
          <div className="lg:w-1/3 w-full flex justify-start items-start">
            <p className="text-black text-lg font-Gotham ">Tariff Prices</p>
          </div>
          <div className="lg:w-[60%] w-full flex flex-col justify-start items-center space-y-2">
            <p className="text-black font-normal text-xs leading-6 font-Gotham">
