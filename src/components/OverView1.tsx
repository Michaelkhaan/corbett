...
const OverView1 = () => {
  return (
    <div className="w-full ">
      <div className=" lg:w-[70%] 2xl:w-[50%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
        <div className="mt-5">
          <h1 className="2xl:text-3xl text-lg font-Gotham font-bold tracking-wide">
            Overview
          </h1>
          <p className="text-[14px] font-Gotham mt-3 tracking-wide leading-6">
          ...
          <p className="mt-5 text-[14px] font-Gotham tracking-wide leading-6">
            {" "}
      ...
      <div className=" lg:w-[70%] 2xl:w-[50%] px-4 mx-auto mt-10">
        <h1 className="text-lg font-bold tracking-wide">
          Accomodation: Rest House a Dhikala Forest
        </h1>
        <p className="text-[14px] tracking-wide leading-6">
        ...
        <h1 className="text-lg font-bold mt-8">Food & Other Serivce</h1>
        <p className="text-[14px] tracking-wide mb-24 leading-6">
