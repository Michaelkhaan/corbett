...
function Index() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-11/12 lg:w-3/4 flex"><p className="cursor-pointer pr-1 font-Gotham text-[10px] flex items-center" onClick={()=>(router.push("/"))}>Home <span className="pl-[3px] mt-[1px]">{'>'} 
            </span></p>
            <p className=" pr-1 font-bold font-Gotham text-[10px] flex items-center">package <span className="pl-[3px] mt-[1px]">
            </span></p>
